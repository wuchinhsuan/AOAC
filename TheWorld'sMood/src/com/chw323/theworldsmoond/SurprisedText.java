...
public class SurprisedText extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.surprisedwords);
		...
		myButtonGC.setOnClickListener(
				new OnClickListener(){
					...
					public void onClick(View arg0){
						...
						Intent i= new Intent(SurprisedText.this, MoodView.class);
						startActivity(i);
